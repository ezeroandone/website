...
<svelte:head>
  ...
  <meta name="description" content="Proven technical engineering deployed in production environments. Case studies and portfolio of high-performance systems built by eZeroAndOne." />
</svelte:head>
